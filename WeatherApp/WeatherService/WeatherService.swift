...
extension WeatherService
{
    func getCurrentWeather(city: String, completionCallback: @escaping (CityCurrentWeather?) -> Void)
    {
    ...
    func getCurrentWeathers(cityIds: [String], completionCallback: @escaping ([CityCurrentWeather]) -> Void)
    {
